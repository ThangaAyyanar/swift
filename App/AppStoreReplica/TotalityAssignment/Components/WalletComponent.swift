...
class WalletComponent{
    ...
    func initialize() {
        ...
        let bottonViewTitle = ViewHelper.getUILabel(text: "Payment Options")
        bottonViewTitle.textAlignment = .center
        bottonViewTitle.font = UIFont.boldSystemFont(ofSize: 20.0)
        
        let bottonViewDescription = ViewHelper.getUILabel(text: "--- select one ---")
        bottonViewDescription.textAlignment = .center
        ...
        nextButton.addTarget(self, action: #selector(bottomSheetView.paymentComponentView), for: .touchUpInside)
        ...
        bottomSheetView.containerView.addSubview(bottonViewDescription)
        ...
        let bottomViewTitleTopPadding: CGFloat = 35
        ...
        let balanceBottonConstraint: NSLayoutConstraint = balance.bottomAnchor.constraint(equalTo: nextButton.topAnchor, constant: -5)
        NSLayoutConstraint.activate([
            ...
            bottonViewDescription.topAnchor.constraint(equalTo: bottomSheetView.containerView.topAnchor, constant: bottomViewTitleTopPadding + 50),
            bottonViewDescription.centerXAnchor.constraint(equalTo: bottomSheetView.containerView.centerXAnchor),
            bottonViewDescription.widthAnchor.constraint(equalTo: bottomSheetView.containerView.widthAnchor),
            bottonViewDescription.heightAnchor.constraint(equalToConstant: 25),
        ...
        DispatchQueue.main.asyncAfter(deadline: dispatchTime) {
            ...
            balanceBottonConstraint.constant = -40
